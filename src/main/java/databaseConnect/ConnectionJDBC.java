...
public class ConnectionJDBC {
    ...
    public static Connection connectToDB() throws IOException {
        ...
        prop.load(new FileInputStream("src/main/resources/parametersJDBC.properties"));

        Log.info("Connect to DB " + URL + " by user " + prop.getProperty("user"));
    ...
    private static void addSQLRequestResultsToLog(String query) throws IOException {
